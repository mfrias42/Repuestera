...
describe('Flujo de actualización de producto como admin', () => {
  it('Debería permitir a un admin actualizar un producto existente', () => {
    ...
    // Esperar un poco para que el UI se actualice
    cy.wait(2000);
    
    // Verificar que el diálogo se cerró (producto actualizado exitosamente)
    cy.contains('Editar Producto').should('not.exist');
  });
});
