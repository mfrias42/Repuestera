...
/**
 * Script para verificar y corregir el rol del administrador en producción
 * Asegura que el administrador tenga rol 'super_admin'
 */
...
async function fixAdminRoleProd() {
  let connection = null;
  
  try {
    console.log('🔍 ============================================');
    console.log('🔍 Verificando Roles de Administradores');
    console.log('🔍 ============================================');
    console.log('');
    ...
    for (const admin of admins) {
      ...
      // Si el rol es NULL, vacío, o no es 'super_admin', actualizarlo
...
module.exports = { fixAdminRoleProd };
